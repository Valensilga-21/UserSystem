...
public class emailService {
	...
	public String enviarCorreoBienvenida(String destinatario, String nombre_completo) {
		try {
            ...
            String cuerpo=""
                    ...
                    + "<h1 style=\"font-size: 24px; font-weight: bold; margin-bottom: 20px;\">¡Hola " + nombre_completo +  "!</h1>\r\n" 
